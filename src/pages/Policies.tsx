  ...
  {p.documentRequirement === 'required' ? <Badge variant="orange">Required</Badge> : p.documentRequirement === 'not_required' ? <Badge variant="gray">Not Required</Badge> : <Badge variant="gray">Optional</Badge>}                </div>
                  <div className="flex items-center justify-between">
                    ...
                    {form.approverIds.map((id) => {
                      ...
                      return (
                        <div key={id} className="flex items-center justify-between rounded-lg border border-blue-100 bg-blue-50 px-3 py-1.5 text-sm">
                          <span className="text-gray-800">{approver.fullName}</span>
                          <button
                            type="button"
