...
export const mockLeavePolicies: LeavePolicy[] = [
  {
    ...
    approvalRouting: { approvers: ['team_leader', 'manager'] },
  ...
  },
  {
    ...
    leaveType: 'sick',
    role: 'All Employees',
    requiresApprovalFrom: 'team_leader',
    approvalRouting: { approvers: ['team_leader'] },
...
export const mockLeaveRequests: LeaveRequest[] = [
  {
    ...
    status: 'pending', currentApproverRole: 'team_leader',
  ...
  },
  {
    ...
    status: 'approved_by_team_leader', currentApproverRole: 'manager',
    approvalHistory: [
      { approverId: 'u3', approverName: 'Priya Sharma', approverRole: 'team_leader', action: 'approved', comment: 'Approved, get well soon.', actionDate: '2026-07-13T14:00:00Z' },
    ],
  ...
  },
  {
    ...
    status: 'approved', currentApproverRole: 'team_leader',
    approvalHistory: [
      { approverId: 'u3', approverName: 'Priya Sharma', approverRole: 'team_leader', action: 'approved', comment: 'Approved.', actionDate: '2026-07-17T10:00:00Z' },
    ],
  ...
  },
  {
    ...
    status: 'rejected', currentApproverRole: 'team_leader',
    approvalHistory: [
      { approverId: 'u3', approverName: 'Priya Sharma', approverRole: 'team_leader', action: 'rejected', comment: 'Critical sprint deadline that week. Please reschedule.', actionDate: '2026-07-16T15:00:00Z' },
    ],
  ...
  },
  {
    ...
    status: 'approved', currentApproverRole: 'team_leader',
    approvalHistory: [
      { approverId: 'u3', approverName: 'Priya Sharma', approverRole: 'team_leader', action: 'approved', actionDate: '2026-06-04T09:00:00Z' },
    ],
  ...
  },
  {
    ...
    approvalHistory: [
      { approverId: 'u3', approverName: 'Priya Sharma', approverRole: 'team_leader', action: 'approved', actionDate: '2026-06-28T10:00:00Z' },
